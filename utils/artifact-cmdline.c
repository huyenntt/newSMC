/*
  ...
  gengetopt --input=./artifact-cmdline.ggo --set-version=4.02 --file-name=artifact-cmdline --include-getopt --show-required --no-handle-error
...
const char *gengetopt_args_info_purpose = "A tool that combines artifacts, goals, and policies.";

const char *gengetopt_args_info_usage = "Usage: artifact [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "\nInputs:",
  "  -a, --artifacts=FILES  Artifacts (mandatory)",
  "  -g, --goal=FILE        Goal specification",
  "  -p, --policies=FILES   Policies",
  "\nOutput:",
  "  -o, --output=FILENAME  Output filename - \"-\" for stdout  (default=`-')",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->artifacts_given = 0 ;
  args_info->goal_given = 0 ;
  args_info->policies_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->artifacts_arg = NULL;
  args_info->artifacts_orig = NULL;
  args_info->goal_arg = NULL;
  args_info->goal_orig = NULL;
  args_info->policies_arg = NULL;
  args_info->policies_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->artifacts_help = gengetopt_args_info_help[3] ;
  args_info->artifacts_min = 0;
  args_info->artifacts_max = 0;
  args_info->goal_help = gengetopt_args_info_help[4] ;
  args_info->policies_help = gengetopt_args_info_help[5] ;
  args_info->policies_min = 0;
  args_info->policies_max = 0;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_multiple_string_field (args_info->artifacts_given, &(args_info->artifacts_arg), &(args_info->artifacts_orig));
  free_string_field (&(args_info->goal_arg));
  free_string_field (&(args_info->goal_orig));
  free_multiple_string_field (args_info->policies_given, &(args_info->policies_arg), &(args_info->policies_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  write_multiple_into_file(outfile, args_info->artifacts_given, "artifacts", args_info->artifacts_orig, 0);
  if (args_info->goal_given)
    write_into_file(outfile, "goal", args_info->goal_orig, 0);
  write_multiple_into_file(outfile, args_info->policies_given, "policies", args_info->policies_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->artifacts_given)
    {
      fprintf (stderr, "%s: '--artifacts' ('-a') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error = 1;
    }
  
  if (check_multiple_option_occurrences(prog_name, args_info->artifacts_given, args_info->artifacts_min, args_info->artifacts_max, "'--artifacts' ('-a')"))
     error = 1;
  
  if (check_multiple_option_occurrences(prog_name, args_info->policies_given, args_info->policies_min, args_info->policies_max, "'--policies' ('-p')"))
     error = 1;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  struct generic_list * artifacts_list = NULL;
  struct generic_list * policies_list = NULL;
  int error = 0;
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVa:g:p:o:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* Artifacts.  */
          ...
          if (update_multiple_arg_temp(&artifacts_list, 
              &(local_args_info.artifacts_given), optarg, 0, 0, ARG_STRING,
              "artifacts", 'a',
              additional_error))
            goto failure;
        
          break;
        case 'g':	/* Goal specification.  */
        
        
          if (update_arg( (void *)&(args_info->goal_arg), 
               &(args_info->goal_orig), &(args_info->goal_given),
              &(local_args_info.goal_given), optarg, 0, 0, ARG_STRING,
        ...
        case 'p':	/* Policies.  */
          ...
          if (update_multiple_arg_temp(&policies_list, 
              &(local_args_info.policies_given), optarg, 0, 0, ARG_STRING,
              "policies", 'p',
              additional_error))
            goto failure;
        
          break;
        case 'o':	/* Output filename - \"-\" for stdout.  */
  ...
  update_multiple_arg((void *)&(args_info->artifacts_arg),
    &(args_info->artifacts_orig), args_info->artifacts_given,
    local_args_info.artifacts_given, 0,
    ARG_STRING, artifacts_list);
  update_multiple_arg((void *)&(args_info->policies_arg),
    &(args_info->policies_orig), args_info->policies_given,
    local_args_info.policies_given, 0,
    ARG_STRING, policies_list);

  args_info->artifacts_given += local_args_info.artifacts_given;
  local_args_info.artifacts_given = 0;
  args_info->policies_given += local_args_info.policies_given;
  local_args_info.policies_given = 0;
...
failure:
  free_list (artifacts_list, 1 );
  free_list (policies_list, 1 );
