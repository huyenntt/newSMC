/*
  ...
  gengetopt --input=./cdnf-cmdline.ggo --set-version=4.02 --file-name=cdnf-cmdline --unamed-opts=FILES --include-getopt --show-required --no-handle-error
...
const char *gengetopt_args_info_purpose = "A command-line converter from petri net final conditions to canonical DNF";

const char *gengetopt_args_info_usage = "Usage: cdnf [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nConfiguration:",
  "      --lola=FILENAME     Set the path and binary of LoLA.  \n                            (default=`lola-statespace')",
  "  The LoLA binary that is compiled with the option `STATESPACE' without \n  reduction techniques. LoLA can be downloaded at \n  http://service-technology.org/lola and compiled using `make lola-statespace'.\n",
...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[7] = gengetopt_args_info_detailed_help[9];
  gengetopt_args_info_full_help[8] = gengetopt_args_info_detailed_help[11];
  ...
  gengetopt_args_info_full_help[11] = 0; 
  
}

const char *gengetopt_args_info_full_help[12];
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[5] = gengetopt_args_info_detailed_help[9];
  gengetopt_args_info_help[6] = gengetopt_args_info_detailed_help[11];
  gengetopt_args_info_help[7] = gengetopt_args_info_detailed_help[12];
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->lola_arg = gengetopt_strdup ("lola-statespace");
  args_info->lola_orig = NULL;
  args_info->tmpfile_arg = gengetopt_strdup ("/tmp/cdnf-XXXXXX");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->lola_help = gengetopt_args_info_detailed_help[5] ;
  args_info->tmpfile_help = gengetopt_args_info_detailed_help[7] ;
  args_info->noClean_help = gengetopt_args_info_detailed_help[9] ;
  args_info->verbose_help = gengetopt_args_info_detailed_help[12] ;
  args_info->stats_help = gengetopt_args_info_detailed_help[13] ;
...
{
  unsigned int i;
  free_string_field (&(args_info->lola_arg));
  free_string_field (&(args_info->lola_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->lola_given)
    write_into_file(outfile, "lola", args_info->lola_orig, 0);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "lola") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->lola_arg), 
                 &(args_info->lola_orig), &(args_info->lola_given),
                &(local_args_info.lola_given), optarg, 0, "lola-statespace", ARG_STRING,
          ...
          else if (strcmp (long_options[option_index].name, "tmpfile") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->tmpfile_arg), 
                ...
                &(local_args_info.tmpfile_given), optarg, 0, "/tmp/cdnf-XXXXXX", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "tmpfile", '-',
                additional_error))
              goto failure;
