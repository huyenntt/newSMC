/*
  ...
  gengetopt --input=./configurator-cmdline.ggo --set-version=4.02 --file-name=configurator-cmdline --unamed-opts=FILES --include-getopt --show-required --no-handle-error
...
const char *gengetopt_args_info_purpose = "A tool that adds a configuration interface to a Petri net.";

const char *gengetopt_args_info_usage = "Usage: configurator [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  -a, --allowByDefault     allow by default -- choose transitions to block",
  "  -b, --blockByDefault     block by default -- choose transitions to allow",
  "  -r, --roles              use role annotations for configuration  \n                             (default=off)",
  "\nInput/Output:",
  ...
  "  The filename CDNF should use to create temporary files. The filename should \n  end with `XXXXXX' which is replaced at runtime with a random string.\n",
  "      --noClean            Do not delete temporary files.  (default=off)",
  "  Any temporary files created by CDNF is kept after CDNF terminates.\n",
  "\nDebugging:",
...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[16] = 0; 
  
}

const char *gengetopt_args_info_full_help[17];
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->allowByDefault_given = 0 ;
  args_info->blockByDefault_given = 0 ;
  args_info->roles_given = 0 ;
  args_info->output_given = 0 ;
  args_info->tmpfile_given = 0 ;
  args_info->noClean_given = 0 ;
  args_info->verbose_given = 0 ;
  args_info->Configuration_default_strategy_group_counter = 0 ;
}
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->roles_flag = 0;
  args_info->output_arg = NULL;
  args_info->output_orig = NULL;
  args_info->tmpfile_arg = gengetopt_strdup ("/tmp/configurator-XXXXXX");
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->allowByDefault_help = gengetopt_args_info_detailed_help[5] ;
  args_info->blockByDefault_help = gengetopt_args_info_detailed_help[6] ;
  args_info->roles_help = gengetopt_args_info_detailed_help[7] ;
  args_info->output_help = gengetopt_args_info_detailed_help[10] ;
  args_info->tmpfile_help = gengetopt_args_info_detailed_help[12] ;
  args_info->noClean_help = gengetopt_args_info_detailed_help[14] ;
  args_info->verbose_help = gengetopt_args_info_detailed_help[17] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->allowByDefault_given)
    write_into_file(outfile, "allowByDefault", 0, 0 );
  if (args_info->blockByDefault_given)
    write_into_file(outfile, "blockByDefault", 0, 0 );
  if (args_info->roles_given)
    write_into_file(outfile, "roles", 0, 0 );
...
static void
reset_group_Configuration_default_strategy(struct gengetopt_args_info *args_info)
{
  if (! args_info->Configuration_default_strategy_group_counter)
    return;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->Configuration_default_strategy_group_counter == 0)
    {
      fprintf (stderr, "%s: %d options of group Configuration default strategy were given. One is required%s.\n", prog_name, args_info->Configuration_default_strategy_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "full-help",	0, NULL, 0 },
        { "version",	0, NULL, 'V' },
        { "allowByDefault",	0, NULL, 'a' },
        { "blockByDefault",	0, NULL, 'b' },
        { "roles",	0, NULL, 'r' },
        { "output",	2, NULL, 'o' },
        { "tmpfile",	1, NULL, 0 },
        { "noClean",	0, NULL, 0 },
      ...
      c = custom_getopt_long (argc, argv, "hVabro::v", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* allow by default -- choose transitions to block.  */
        
          if (args_info->Configuration_default_strategy_group_counter && override)
            reset_group_Configuration_default_strategy (args_info);
          args_info->Configuration_default_strategy_group_counter += 1;
        
          if (update_arg( 0 , 
               0 , &(args_info->allowByDefault_given),
              &(local_args_info.allowByDefault_given), optarg, 0, 0, ARG_NO,
          ...
          break;
        case 'b':	/* block by default -- choose transitions to allow.  */
          ...
          if (update_arg( 0 , 
               0 , &(args_info->blockByDefault_given),
              &(local_args_info.blockByDefault_given), optarg, 0, 0, ARG_NO,
              check_ambiguity, override, 0, 0,
              "blockByDefault", 'b',
              additional_error))
            goto failure;
          ...
          break;
        case 'r':	/* use role annotations for configuration.  */
        
        
          if (update_arg((void *)&(args_info->roles_flag), 0, &(args_info->roles_given),
              &(local_args_info.roles_given), optarg, 0, 0, ARG_FLAG,
              check_ambiguity, override, 1, 0, "roles", 'r',
              additional_error))
            goto failure;
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "tmpfile") == 0)
          {
          
          
            if (update_arg( (void *)&(args_info->tmpfile_arg), 
                 &(args_info->tmpfile_orig), &(args_info->tmpfile_given),
                &(local_args_info.tmpfile_given), optarg, 0, "/tmp/configurator-XXXXXX", ARG_STRING,
                check_ambiguity, override, 0, 0,
                "tmpfile", '-',
                additional_error))
              goto failure;
  ...
  if (args_info->Configuration_default_strategy_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group Configuration default strategy were given. One is required%s.\n", argv[0], args_info->Configuration_default_strategy_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
