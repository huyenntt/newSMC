/*
  ...
  gengetopt --input=./cmdline.ggo --set-version=4.02 --file-name=cmdline --unamed-opts=FILES --include-getopt --show-required --no-handle-error --conf-parser
...
init_full_help_array(void)
{
  ...
  gengetopt_args_info_full_help[32] = gengetopt_args_info_detailed_help[34];
  ...
  gengetopt_args_info_full_help[37] = gengetopt_args_info_detailed_help[40];
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[29] = gengetopt_args_info_detailed_help[34];
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->canonicalNames_arg = NULL;
  args_info->canonicalNames_orig = NULL;
  args_info->formula_flag = 0;
  args_info->removePorts_flag = 0;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->removePorts_help = gengetopt_args_info_detailed_help[9] ;
  args_info->guessFormula_help = gengetopt_args_info_detailed_help[10] ;
  args_info->genet_help = gengetopt_args_info_detailed_help[12] ;
  args_info->petrify_help = gengetopt_args_info_detailed_help[13] ;
  args_info->compose_help = gengetopt_args_info_detailed_help[15] ;
  args_info->produce_help = gengetopt_args_info_detailed_help[16] ;
  args_info->isFreeChoice_help = gengetopt_args_info_detailed_help[18] ;
  args_info->isNormal_help = gengetopt_args_info_detailed_help[19] ;
  args_info->isWorkflow_help = gengetopt_args_info_detailed_help[20] ;
  args_info->check_help = gengetopt_args_info_detailed_help[21] ;
  args_info->reduce_help = gengetopt_args_info_detailed_help[23] ;
  args_info->reduce_min = 0;
  args_info->reduce_max = 0;
  args_info->normalize_help = gengetopt_args_info_detailed_help[24] ;
  args_info->negate_help = gengetopt_args_info_detailed_help[25] ;
  args_info->mirror_help = gengetopt_args_info_detailed_help[26] ;
  args_info->dnf_help = gengetopt_args_info_detailed_help[27] ;
  args_info->config_help = gengetopt_args_info_detailed_help[29] ;
  args_info->dot_help = gengetopt_args_info_detailed_help[31] ;
  args_info->tmpfile_help = gengetopt_args_info_detailed_help[32] ;
  args_info->noClean_help = gengetopt_args_info_detailed_help[34] ;
  args_info->verbose_help = gengetopt_args_info_detailed_help[37] ;
  args_info->suffix_owfn_help = gengetopt_args_info_detailed_help[38] ;
  args_info->suffix_owfn_min = 0;
  args_info->suffix_owfn_max = 0;
  args_info->suffix_sa_help = gengetopt_args_info_detailed_help[39] ;
  args_info->suffix_sa_min = 0;
  args_info->suffix_sa_max = 0;
  args_info->stats_help = gengetopt_args_info_detailed_help[40] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->canonicalNames_arg));
  free_string_field (&(args_info->canonicalNames_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->canonicalNames_given)
    write_into_file(outfile, "canonicalNames", args_info->canonicalNames_orig, 0);
  if (args_info->formula_given)
    write_into_file(outfile, "formula", 0, 0 );
  if (args_info->removePorts_given)
    write_into_file(outfile, "removePorts", 0, 0 );
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        ...
        { "input",	1, NULL, 'i' },
        { "output",	1, NULL, 'o' },
        { "canonicalNames",	2, NULL, 0 },
        { "formula",	0, NULL, 'f' },
        { "removePorts",	0, NULL, 0 },
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "canonicalNames") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->canonicalNames_arg), 
                 &(args_info->canonicalNames_orig), &(args_info->canonicalNames_given),
                &(local_args_info.canonicalNames_given), optarg, 0, 0, ARG_STRING,
                check_ambiguity, override, 0, 0,
                "canonicalNames", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "removePorts") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->removePorts_flag), 0, &(args_info->removePorts_given),
                &(local_args_info.removePorts_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "removePorts", '-',
                additional_error))
              goto failure;
